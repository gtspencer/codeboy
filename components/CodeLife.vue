<template>
  <div>
    <section class="meetings mt-10 lg:mt-20 xl:mt-32">
        <div class="top-container flex justify-center items-center space-x-3">
            <img class="w-[130px] sm:w-[170px] lg:w-[200px] xl:w-[300px] rounded-lg" src="https://res.cloudinary.com/eazzie/image/upload/q_100/v1643853024/Codeboy/CODE_LIFE_ALBUM_COVER_ART_isbmud.webp" alt="Code Life Cover Image">
            <img class="w-[130px] sm:w-[170px] lg:w-[200px] xl:w-[300px] rounded-lg" src="https://res.cloudinary.com/eazzie/image/upload/q_100/v1643853024/Codeboy/CODE_LIFE_ALBUM_TRACKLIST_ART_lrylk7.webp" alt="Code Life Cover Image">
        </div>
        ...
        <div v-for="codeLife in codeLife" :key="codeLife.id" class="track-container currentTile relative py-3 flex justify-between after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-[#E5E5E5] cursor-pointer" ref="currentTile">
            <div class="left-container flex justify-between items-center w-[57%] md:w-[49%]">
                <div class=".left-container flex items-center space-x-2">
                    <div class="cover w-14 h-14 rounded-lg bg-center bg-contain" :style="{ backgroundImage: `url( ${codeLife.cover} )`}">
                        <!-- <p>
                            {{ track.cover }}
                        </p> -->
                    </div>
                ...
                <div class="right-container">
                    <button class="play w-7 h-7 rounded-full bg-[#6837FA] flex justify-center items-center" ref="play" @click="playSong(codeLife.id, codeLife.name)">
