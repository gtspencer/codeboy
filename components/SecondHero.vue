<template>
  <section class="hero">
    <div
      class="hero-container sm:grid grid-cols-2 lg:grid-cols-3 xl:px-10 2xl:px-20 py-10 lg:py-16 xl:py-20"
    >
      ...
      >
        <div class="mint-collectibles-container">
          ...
          <div class="button flex lg:block justify-center mt-5">
            <button
