<template>
  <div
    class="exit w-full h-screen bg-white flex justify-center items-center overflow-hidden fixed bottom-0 left-0 z-[-10] h-0"
  >
    <div
      class="overflow-hidden flex flex-col justify-center items-center space-y-3"
    >
