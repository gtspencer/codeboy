  ...
  <div>
        ...
        <div class="top sm:grid grid-cols-2 lg:grid-cols-4 space-y-7 sm:space-y-0 sm:gap-y-7 overflow-hidden">
          <div class="header-and-image col-span-2 sm:text-center lg:text-left">
            ...
            <div data-aos="fade-in" data-aos-duration="1000" class="flex justify-center xl:justify-start">
              <video
                class="md:-ml-10"
                src="https://res.cloudinary.com/eazzie/video/upload/q_100/v1643320828/Codeboy/SILVERDESK-215X716_jk4vhv.webm"
          ...
          <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" class="position-ar-scout justify-self-center">
              <p class="post font-monument-regular text-white text-xl xl:text-xl 2xl:t2xt-4xl">
                A&R Scout
              </p>
              ...
              <p class="details font-monument-light text-white text-[10px] xl:text-xs 2xl:text-sm pr-10 xl:pr-14 2xl:pr-28 xl:leading-relaxed">
    ...
    <section class="executive my-32 xl:px-20 overflow-hidden">
      <div class="executive space-y-10 sm:space-y-0 sm:grid grid-cols-2">
        ...
        <div class="bottom-right flex flex-col justify-center items-center overflow-hidden">
          <h2 data-aos="fade-right" data-aos-duration="1000" data-aos-delay="" class="font-monument-regular text-white text-[34px] sm:text-[40px] lg:text-[44px] 2xl:text-6xl">
            Executive
          </h2>

          <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200" class="requirement font-monument-regular text-white text-sm lg:text-base xl:text-lg 2xl:text-xl mt-2 xl:mt-3 mb-1 xl:mb-2">
            7 Total Executives Positions
          </p>

          <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400" class="details font-monument-light text-white text-[10px] lg:text-xs xl:text-sm 2xl:text-base leading-loose xl:leading-loose text-center mt-3">
